...
#include "bfh_ti_i2c_color_logger_I2C.h"
...
JNIEXPORT jint JNICALL Java_bfh_ti_i2c_1color_1logger_I2C_open(JNIEnv *env, jobject obj, jstring file)
  {
   #ifndef EMULATOR
...
JNIEXPORT jint JNICALL Java_bfh_ti_i2c_1color_1logger_I2C_SetSlaveAddress(JNIEnv *env, jobject obj, jint file, jint slaveAddr)
  {
   #ifndef EMULATOR
...
JNIEXPORT jint JNICALL Java_bfh_ti_i2c_1color_1logger_I2C_read(JNIEnv * env, jobject obj, jint fileHander, jintArray bufArray, jint len)
...
JNIEXPORT jint JNICALL Java_bfh_ti_i2c_1color_1logger_I2C_write(JNIEnv *env, jobject obj, jint fileHander, jintArray inJNIArray, jint len)
 {
  #ifndef EMULATOR
...
JNIEXPORT void JNICALL Java_bfh_ti_i2c_1color_1logger_I2C_close(JNIEnv *env, jobject obj, jint fileHander)
 {
   #ifndef EMULATOR
    close(fileHander);
   #endif
